...
const Form: React.FC<FormProps> = (props) => {
  const isPromptValid =
    props.prompt.length < props.characterLimit && props.prompt.length > 0;
  ...
  return (
    <>
      <div className="mb-6 text-slate-400">
        <p className="">
          Tell me a topic and i will tell you a short story and give it you a
          title.
        </p>
      </div>

      <input
        className="p-2 w-full rounded focus:outline-teal-300 focus:outline text-slate-700"
        type="text"
        placeholder="coffee"
        value={props.prompt}
